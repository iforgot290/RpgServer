...
public class Leggings implements MenuItem, BonusItem<ItemTier> {
	...
	public ItemStack getItem() {
		return new Builder(tier.getMaterialFromType(ItemType.LEGGINGS))
				.setName(tier.getTierColor() + "Get Random " + tier.name() + " Leggings")
				.setLore(Arrays.asList(ChatColor.GRAY + "Spawn Random " + tier.name() + " Leggings")).getItem();
	}
