...
public class Bow implements MenuItem, BonusItem<ItemTier> {
	...
	public ItemStack getItem() {
		return new Builder(tier.getMaterialFromType(ItemType.BOW))
				.setName(tier.getTierColor() + "Get Random " + tier.name() + " Bow")
				.setLore(Arrays.asList(ChatColor.GRAY + "Spawn Random " + tier.name() + " Bow")).getItem();
	}
