...
public class Staff implements MenuItem, BonusItem<ItemTier> {
	...
	public ItemStack getItem() {
		return new Builder(tier.getMaterialFromType(ItemType.STAFF))
				.setName(tier.getTierColor() + "Get Random " + tier.name() + " Staff")
				.setLore(Arrays.asList(ChatColor.GRAY + "Spawn Random " + tier.name() + " Staff")).getItem();
	}
