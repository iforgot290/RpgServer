...
public enum ItemTier {
	...
	/**
	 * Gets the ItemTier of a material. DOES NOT CHECK IF ITEM IS ARMOR OR
	 * WEAPON! Does not support bows because they are all wood.
	 * 
	 * @param m
	 * @return
	 */
	public static ItemTier getTierFromMaterial(Material m) { // TODO: make this
																// check if item
																// is armor or
																// weapon, am
																// too lazy atm
