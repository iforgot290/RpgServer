	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		for(UUID s : GuildMechanics.getGuildMembers(guild_name)) {
			if(Bukkit.getPlayer(s) != null) {
				...
				pty_mem.sendMessage(ChatColor.DARK_AQUA + "<" + ChatColor.BOLD + GuildMechanics.guild_handle_map.get(guild_name) + ChatColor.DARK_AQUA + "> " + ChatColor.DARK_AQUA.toString() + p.getName() + ChatColor.GRAY.toString() + " has " + ChatColor.UNDERLINE + "joined" + ChatColor.GRAY + " your guild.");
			}
		}
