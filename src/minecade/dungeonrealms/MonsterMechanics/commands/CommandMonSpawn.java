		...
		if (sender instanceof Player) {
			...
			if (args.length != 6) {
				...
				p.sendMessage(ChatColor.GRAY
						+ "(meta_data) and (custom_name) are optional, do not use meta_data unless you talk to Vaquxine, custom_name cannot contain spaces. Use 'null' if you do not want to set a value for these two options.");
				p.sendMessage(ChatColor.RED
						+ "(level_tier) must be a number between 1 - 4 and will determine the level tier of the mob. EX: (level_tier 1) with a mob tier of 3 will make the mobs level 40 - 44");
				return true;
			}
			 ...
			 * String meta_data, String custom_name) {
			 */
