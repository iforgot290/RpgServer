...
public class CommandSetFish implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		p.sendMessage(ChatColor.GRAY
				+ "The game will record every location where you place these lilypads as a fishing spot for the tier. Type '/setfish none' to stop.");
		p.sendMessage(ChatColor.RED
				+ "Please also note that any water spot within 10 blocks of a placed fishing spot will inherent the spot's properties.");
		return true;
	}
