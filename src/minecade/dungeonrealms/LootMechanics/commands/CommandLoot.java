...
public class CommandLoot implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (args.length > 0 && args[0].equalsIgnoreCase("chunk")) {
			p.getInventory()
					.addItem(ItemMechanics.signNewCustomItem(Material.MAGMA_CREAM, (short) 0,
							ChatColor.LIGHT_PURPLE.toString() + "Orb of Alteration", ChatColor.GRAY.toString()
			...
			return true;
			// p.sendMessage(MonsterMechanics.loaded_chunks.contains(p.getLocation().getChunk().getBlock(0,
			// 0, 0).getLocation()));
		}
