...
public class PlayerModel {
	...
	private List<UUID> buddyList = new ArrayList<UUID>();
	...
	public List<UUID> getBuddyList() {
		return buddyList;
	}

	public void setBuddyList(List<UUID> buddyList) {
		this.buddyList = buddyList;
	}

	public List<UUID> getLocalConfirmedBuddies() {
		return localConfirmedBuddies;
	}

	public void setLocalConfirmedBuddies(List<UUID> localConfirmedBuddies) {
	...
	public List<UUID> getLocalConfirmedIgnores() {
		return localConfirmedIgnores;
	}

	public void setLocalConfirmedIgnores(List<UUID> localConfirmedIgnores) {
