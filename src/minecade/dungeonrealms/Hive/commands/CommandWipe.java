		...
		if (sender instanceof Player) {
			...
			try {
				pst = ConnectionPool.getConnection()
						.prepareStatement("DELETE FROM player_database where p_name='" + p_name + "'");
				pst.executeUpdate();
				pst = ConnectionPool.getConnection()
						.prepareStatement("DELETE FROM bank_database where p_name='" + p_name + "'");
				pst.executeUpdate();
				pst = ConnectionPool.getConnection()
						.prepareStatement("DELETE FROM shop_database where p_name='" + p_name + "'");
				pst.executeUpdate();
				pst = ConnectionPool.getConnection()
						.prepareStatement("DELETE FROM statistics where pname='" + p_name + "'");
				pst.executeUpdate();
				pst = ConnectionPool.getConnection()
						.prepareStatement("DELETE FROM statistics_old where pname='" + p_name + "'");
				pst.executeUpdate();
				pst = ConnectionPool.getConnection()
						.prepareStatement("DELETE FROM perm_statistics where pname='" + p_name + "'");
				pst.executeUpdate();
